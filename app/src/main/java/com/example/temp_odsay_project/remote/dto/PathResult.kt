...
data class SearchInfo(
    ...
    @SerializedName("subwayCount") val subwayCount: Int,
...
data class PathInfo(
    ...
    @SerializedName("subwayTransitCount") val subwayTransitCount: Int,
    @SerializedName("mapObj") val mapObj: String,
    ...
    @SerializedName("subwayStationCount") val subwayStationCount: Int,
    @SerializedName("totalDistance") val totalDistance: Int,
    @SerializedName("totalWalkTime") val totalWalkTime: Int,
